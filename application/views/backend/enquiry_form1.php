<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <i class="fa fa-tachometer" aria-hidden="true"></i> Enquiry <small>Control panel</small> </h1>
  </section>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/enquiry/ajax_list')?>",
            "type": "POST"
        },
...
function status_on(id,smethod)
{
    //alert(smethod);
	$.ajax({
        url : "<?php echo site_url('admin/enquiry/ajax_status_on')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
{
    $.ajax({
        url : "<?php echo site_url('admin/enquiry/ajax_status_off')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function order_block(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/enquiry/add_order')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function edit_block(id)
{
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('admin/enquiry/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/enquiry/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin/enquiry/ajax_update')?>";
    }
...
function delete_block(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/enquiry/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
$(document).ready(function() 
{
	...
	$("#del_all").on('click', function(e) 
	{
		if(confirm('Are you sure delete all data?'))
		{
			...
			$.ajax
			({
				url: '<?php echo site_url('admin/enquiry/ajax_multi_delete')?>',
				type: 'post',
