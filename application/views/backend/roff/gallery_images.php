<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <i class="fa fa-tachometer" aria-hidden="true"></i> Gallery Images </small> </h1>
  </section>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
			"url": "<?php echo site_url('admin/gallery_images/ajax_list/'.$title_id)?>",
            "type": "POST"
        },
...
function status_on(id,smethod)
{
    //alert(smethod);
	$.ajax({
        url : "<?php echo site_url('admin/gallery_images/ajax_status_on')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
{
    $.ajax({
        url : "<?php echo site_url('admin/gallery_images/ajax_status_off')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function edit_block(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/gallery_images/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            {
                $('#label-photo').text('Change Photo (1140 * 440 px) (Upto 1 mb)'); 
                $('#photo-preview div').html('<img width="170px" height="170px" src="'+base_url+'gly/'+data.form_data.photo+'" class="img-responsive">'); 
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/gallery_images/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin/gallery_images/ajax_update')?>";
    }
...
function delete_block(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/gallery_images/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
$(document).ready(function() 
{
	...
	$("#del_all").on('click', function(e) 
	{
		if(confirm('Are you sure delete all data?'))
		{
			...
			$.ajax
			({
				url: '<?php echo site_url('admin/gallery_images/ajax_multi_delete')?>',
				type: 'post',
