<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <i class="fa fa-tachometer" aria-hidden="true"></i> Gallery Titles </small> </h1>
  </section>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
			"url": "<?php echo site_url('admin/gallery_titles/ajax_list/'.$category_id)?>",
            "type": "POST"
        },
...
function status_on(id,smethod)
{
    //alert(smethod);
	$.ajax({
        url : "<?php echo site_url('admin/gallery_titles/ajax_status_on')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
{
    $.ajax({
        url : "<?php echo site_url('admin/gallery_titles/ajax_status_off')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function add_block()
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/gallery_titles/ajax_addform')?>",
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
			...
			$('[name="category_id"]').val(<?=$this->uri->segment(3)?>);
			//console.log(data);
...
function edit_block(id)
{
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('admin/gallery_titles/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
			...
			$('#photo-preview div').html('<img width="170px" height="170px" src="'+base_url+'gallery_titles/'+data.form_data.photo+'" class="img-responsive">'); 
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/gallery_titles/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin/gallery_titles/ajax_update')?>";
    }
...
function delete_block(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/gallery_titles/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
$(document).ready(function() 
{
	...
	$("#del_all").on('click', function(e) 
	{
		if(confirm('Are you sure delete all data?'))
		{
			...
			$.ajax
			({
				url: '<?php echo site_url('admin/gallery_titles/ajax_multi_delete')?>',
				type: 'post',
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="title_en" placeholder="Name (english) " class="form-control" type="text">
                <span class="help-block"></span> </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3">Name (Hindi) </label>
              <div class="col-md-9">
                <input name="title_hi" placeholder="Name (Hindi) " class="form-control" type="text">
                <span class="help-block"></span> </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-md-3">Posted On</label>
              <div class="col-md-9">
                <input name="posted_on" placeholder="posted on" class="form-control datepicker" type="text">
                <span class="help-block"></span> </div>
            </div>
